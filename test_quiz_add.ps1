...
# Check if user creation was successful (crude check for "success" in the response)
if ($createUserResponse -notlike "*success*") {
    Write-Host "Error: Failed to create user. Aborting."
    exit 1
}
